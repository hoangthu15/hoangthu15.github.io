...
$exec_url = $_SERVER['REQUEST_URI'];
	...
	if($exec_url == '/' || $exec_url == '/home' || $exec_url == '/index.php' || $exec_url == '/index.html') {
		...
		$title = 'Random Nick Freefire Và Hack VIP';
...
if($kun->is_admin()) $btn_admin = '<li class=" "><a rel="" href="/admin" class=""><b><i class="icon-user"></i> Quản Lý Shop</b></a></li>'; else $btn_admin = '';
